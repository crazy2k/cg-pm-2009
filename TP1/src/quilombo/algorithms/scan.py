class TriangleScanAlgorithm:
    ...
    def scan(vertex1, vertex2, vertex3, draw_segment, putpixel):
        x1 = vertex1(0)
        y1 = vertex1(1)
        x2 = vertex2(0)
        y2 = vertex2(1)
        ...
        draw_segment(x1, y1, x2, y2, __max_setter)
        draw_segment(x2, y2, x3, y3, __max_setter)
        draw_segment(x1, y1, x3, y3, __max_setter)
